...
%>
             ...
             <input id="id" type="hidden" name="id" value="<%=id %>"  />
              <div class="textarea">
                <textarea cols="30" placeholder="Write your experience in here.." name="msg" value="<%=msg%>"></textarea>
                <input id="rating" type="hidden" name="rating"  value="<%=rating %>" />
              </div>
                <br>
              <div class="e">
                <textarea cols="20" placeholder="E-mail address" value="<%=email %>" name="email"></textarea>
              </div>
